...
export function AdminCourseOversight() {
    ...
    const fetchCourses = async () => {
      try {
        ...
        if (response.data.success) {
          ...
          const coursesWithAverages = await attachClassAveragesToCourses(coursesArray, headers);
  ...
  if (loading) {
    return (
      <MobileAppShell title="Courses" backButtonPath="/dashboard">
  ...
  return (
    ...
    <div className="p-3 sm:p-4 lg:p-6 space-y-4 sm:space-y-6">
      ...
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-3 sm:gap-0">
        <div>
          <h1 className="hidden lg:block text-2xl sm:text-3xl font-bold text-gray-900 dark:text-gray-100">Course Oversight</h1>
      ...
      <DataTable<Course>
        ...
        renderMobileCard={(course) => (
          <div className="rounded-lg border border-gray-200 bg-white p-4 shadow dark:border-gray-700 dark:bg-gray-800">
            <button
              ...
              className="mb-2 text-left text-sm font-semibold text-blue-600 dark:text-blue-400"
            >
              {course.catalog?.courseCode || course.title}
            </button>
            <p className="mb-3 text-xs text-gray-500 dark:text-gray-400">{course.instructor}</p>
            ...
            <div className="mb-3 grid grid-cols-2 gap-2 text-xs text-gray-600 dark:text-gray-400">
              ...
              <div className="flex items-center gap-1">
                ...
                <span className={getAverageColor(course.classAverage)}>
                  {course.classAverage != null ? `${course.classAverage.toFixed(1)}%` : 'N/A'}
                </span>
              </div>
        ...
        bulkActions={
          <>
              ...
              className="flex min-h-[44px] items-center gap-1 rounded px-3 py-2 text-xs text-green-700 transition-colors hover:bg-green-200 disabled:cursor-not-allowed disabled:opacity-50 sm:text-sm dark:bg-green-900/50 dark:text-green-300 dark:hover:bg-green-900/70"
                    >
              ...
              disabled={bulkActionLoading}
              className="flex min-h-[44px] items-center gap-1 rounded px-3 py-2 text-xs text-yellow-700 transition-colors hover:bg-yellow-200 disabled:cursor-not-allowed disabled:opacity-50 sm:text-sm dark:bg-yellow-900/50 dark:text-yellow-300 dark:hover:bg-yellow-900/70"
                      >
              ...
              disabled={bulkActionLoading}
              className="flex min-h-[44px] items-center gap-1 rounded px-3 py-2 text-xs text-gray-700 transition-colors hover:bg-gray-200 disabled:cursor-not-allowed disabled:opacity-50 sm:text-sm dark:bg-gray-700 dark:text-gray-300 dark:hover:bg-gray-600"
                        >
              ...
              disabled={bulkActionLoading}
              className="flex min-h-[44px] items-center gap-1 rounded px-3 py-2 text-xs text-red-700 transition-colors hover:bg-red-200 disabled:cursor-not-allowed disabled:opacity-50 sm:text-sm dark:bg-red-900/50 dark:text-red-300 dark:hover:bg-red-900/70"
                      >
