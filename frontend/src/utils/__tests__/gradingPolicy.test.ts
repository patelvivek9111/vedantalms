...
import { getGradebookCellForExport } from '../gradebookExport';
import {
  STUDENT_ID,
...
function runScenario(scenario: {
  studentId: string;
  course: ReturnType<typeof import('../../test/grading/fixtures').buildCourse>;
  assignments: ReturnType<typeof import('../../test/grading/fixtures').buildAssignment>[];
  grades: ReturnType<typeof import('../../test/grading/fixtures').buildGrades>;
