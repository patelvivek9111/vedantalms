...
const QuizSessionControl: React.FC<QuizSessionControlProps> = ({
  ...
  if (!session) {
    return (
      <div className="fixed inset-0 z-[110] flex items-center justify-center bg-slate-50 dark:bg-slate-950">
  ...
  if (isQuizActive || isEnded) {
    return (
      <div className="fixed inset-0 left-0 z-[110] flex h-full flex-col overflow-hidden bg-slate-100/90 dark:bg-slate-950">
