...
const MobileQuizChrome: React.FC<MobileQuizChromeProps> = ({
  ...
  return (
    <>
      ...
      <div className="fixed bottom-[calc(4rem+env(safe-area-inset-bottom,0px))] left-0 right-0 z-[140] border-t border-slate-200/90 bg-white px-3 py-3 dark:border-slate-700/90 dark:bg-slate-950 lg:hidden">
        {mode === 'scrollable' ? (
          <button
            type="button"
            onClick={onSubmit}
