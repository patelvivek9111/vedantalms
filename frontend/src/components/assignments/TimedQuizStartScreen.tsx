...
const TimedQuizStartScreen: React.FC<TimedQuizStartScreenProps> = ({
  ...
  return (
    <>
      ...
      <div className="mobile-fixed-chrome mobile-quiz-action-bar fixed bottom-[calc(4rem+env(safe-area-inset-bottom,0px))] left-0 right-0 z-[140] border-t border-slate-200 bg-white px-4 py-3 dark:border-slate-700 dark:bg-slate-950 sm:hidden">
        <button
          type="button"
          onClick={onStart}
          disabled={isStarting}
