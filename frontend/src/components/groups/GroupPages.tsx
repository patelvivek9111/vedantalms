  ...
  return (
    <div className="bg-white dark:bg-gray-800 rounded-lg shadow-md p-4 sm:p-6 border dark:border-gray-700">
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-3 sm:gap-0 mb-4 sm:mb-6">
        <div>
          <h2 className="text-xl sm:text-2xl font-bold text-gray-800 dark:text-gray-100">Group Pages</h2>
          <p className="text-sm sm:text-base text-gray-600 dark:text-gray-400 mt-1">Pages shared with this group set</p>
        </div>
        {isInstructor && (
          <button
