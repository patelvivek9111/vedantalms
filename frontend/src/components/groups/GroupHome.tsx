...
const GroupHome: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-indigo-50 to-purple-50 dark:from-gray-900 dark:via-slate-900 dark:to-gray-900 p-4 sm:p-6">
        ...
        <div className="bg-white dark:bg-gray-800 dark:!bg-gray-800 rounded-2xl shadow-lg p-4 sm:p-6 lg:p-8 border border-gray-100 dark:border-gray-700 dark:!border-gray-700 hover:shadow-xl transition-all duration-300">
          <div className="flex items-center justify-center">
            <div className="text-center">
              ...
              <p className="text-gray-600 dark:text-gray-300 text-sm sm:text-base lg:text-lg mb-1">
              ...
              <div className="flex items-center justify-center mt-3 space-x-2 sm:space-x-4">
                <div className="flex items-center text-xs sm:text-sm text-gray-600 dark:text-gray-300 bg-gray-50 dark:bg-gray-700 px-2 sm:px-3 py-1 sm:py-1.5 rounded-full border dark:border-gray-600">
                  <Users className="h-3 w-3 sm:h-3.5 sm:w-3.5 mr-1 sm:mr-1.5 text-gray-500 dark:text-gray-400" />
      ...
      {isTeacher && (
        <div className="bg-white dark:bg-gray-800 dark:!bg-gray-800 rounded-xl shadow-lg border border-gray-100 dark:border-gray-700 dark:!border-gray-700 p-4 sm:p-6 mb-6 sm:mb-8">
          <h2 className="text-lg sm:text-xl font-semibold text-gray-900 dark:text-gray-100 mb-4 sm:mb-5 flex items-center">
            <div className="p-1.5 bg-yellow-50 dark:bg-yellow-900/50 rounded-lg mr-2.5">
              <Star className="h-3.5 w-3.5 sm:h-4 sm:w-4 text-yellow-500 dark:text-yellow-400" />
            </div>
            Quick Actions
          </h2>
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-4">
            <button 
              ...
              className="group flex flex-col items-center p-4 sm:p-6 border-2 border-gray-200 dark:border-gray-700 rounded-xl hover:border-blue-400 dark:hover:border-blue-500 hover:bg-blue-50/50 dark:hover:bg-blue-900/20 transition-all duration-300 transform hover:-translate-y-1 hover:shadow-md"
            >
              <div className="p-2 sm:p-3 bg-gradient-to-br from-blue-100 to-blue-50 dark:from-blue-900/50 dark:to-blue-800/50 rounded-full mb-2 sm:mb-3 group-hover:from-blue-200 group-hover:to-blue-100 dark:group-hover:from-blue-800 dark:group-hover:to-blue-700 transition-all duration-300 shadow-sm">
                <Plus className="h-5 w-5 sm:h-6 sm:w-6 text-blue-600 dark:text-blue-400 group-hover:scale-110 transition-transform" />
              </div>
              <div className="text-center">
                <div className="font-semibold text-sm sm:text-base text-gray-900 dark:text-gray-100 mb-1 group-hover:text-blue-600 dark:group-hover:text-blue-400 transition-colors">Create Assignment</div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 sm:gap-6">
        ...
        <div className="bg-white dark:bg-gray-800 dark:!bg-gray-800 rounded-xl shadow-lg border border-gray-100 dark:border-gray-700 dark:!border-gray-700 p-4 sm:p-6">
          <div className="flex items-center justify-between mb-4 sm:mb-5 pb-3 sm:pb-4 border-b border-gray-100 dark:border-gray-700">
            ...
            <button 
              ...
              className="text-blue-600 dark:text-blue-400 hover:text-blue-800 dark:hover:text-blue-300 text-xs sm:text-sm font-medium hover:underline transition-colors"
            >
              View all members
            </button>
          </div>
                ...
                {groupInfo.members.slice(0, 4).map((member, index) => (
                  ...
                  >
                    ...
                    <div className="flex-1 min-w-0">
                      <p className="text-xs sm:text-sm font-semibold text-gray-900 dark:text-gray-100 truncate mb-0.5">
        ...
        <div className="bg-white dark:bg-gray-800 dark:!bg-gray-800 rounded-xl shadow-lg border border-gray-100 dark:border-gray-700 dark:!border-gray-700 p-4 sm:p-6">
          <div className="flex items-center justify-between mb-4 sm:mb-5 pb-3 sm:pb-4 border-b border-gray-100 dark:border-gray-700">
            ...
            <button 
              ...
              className="text-orange-600 dark:text-orange-400 hover:text-orange-800 dark:hover:text-orange-300 text-xs sm:text-sm font-medium hover:underline transition-colors"
            >
              View all tasks
            </button>
          </div>
