...
export default function GlobalSidebar() {
  ...
  return (
    <nav 
      className="fixed top-0 left-0 h-full bg-blue-900 dark:bg-gray-900 flex flex-col items-center py-4 z-50 shadow-lg border-r-2 border-blue-700 dark:border-gray-700" 
