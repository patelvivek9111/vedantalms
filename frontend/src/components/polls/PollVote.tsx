...
const PollVote: React.FC<PollVoteProps> = ({ poll, onVoteSuccess }) => {
  ...
  if (poll.hasVoted) {
    return (
      <div className="bg-green-50 dark:bg-green-900/20 border border-green-200 dark:border-green-700 rounded-lg p-3 sm:p-4">
        ...
        {poll.studentVote && (
          <div className="mt-2 text-xs sm:text-sm text-green-700 dark:text-green-300">
  ...
  return (
    <div className="space-y-3 sm:space-y-4">
            ...
            <div key={index} className="relative">
              ...
              >
                <div className="flex items-center gap-2 sm:gap-3">
                  ...
                  <span className="text-sm sm:text-base text-gray-900 dark:text-gray-100 font-medium break-words">
                    {option.text}
                  </span>
                </div>
              </button>
      ...
      <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3 sm:gap-0 pt-3 sm:pt-4">
        ...
        <button
          ...
          className="w-full sm:w-auto px-4 sm:px-6 py-2 bg-blue-600 hover:bg-blue-700 text-white rounded-lg transition-colors disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-2 text-sm sm:text-base"
        >
          {loading ? (
            <>
