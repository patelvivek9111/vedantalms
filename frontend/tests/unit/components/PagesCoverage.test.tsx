...
vi.mock('@/components/common/ToDoPanel', () => ({
...
vi.mock('@/components/layout/NavCustomizationModal', () => ({
  NavCustomizationModal: () => <div>NavCustomizationModal</div>,
  ALL_NAV_OPTIONS: [],
  DEFAULT_NAV_ITEMS: []
}));

vi.mock('@/components/modals/ChangeUserModal', () => ({
...
vi.mock('@/components/layout/BurgerMenu', () => ({
...
vi.mock('@/components/modules/CreateModuleForm', () => ({
  default: () => <div>CreateModuleForm</div>
}));

vi.mock('@/components/modules/ModuleList', () => ({
